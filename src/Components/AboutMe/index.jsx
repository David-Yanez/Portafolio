  ...
  return (
    ...
    <div className='flex gap-40 mt-40 '>
      ...
      <span className='w-96'>
        ...
        <button
          class=' mt-20 ml-40 w-28 h-12 text-white font-semibold   bg-gradient-to-r from-sky-700 via-sky-800 to-blue-800   rounded-lg shadow-lg hover:scale-105 duration-200 hover:drop-shadow-2xl hover:shadow-[#7dd3fc] hover:cursor-pointer'
        >
          Contacto
        </button>
